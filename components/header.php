    ...
    <div class="row">
        ...
        <div class="col-6 col-sm-3 col-md-2 col-lg-3 col-xl-2 mt-3"><?php
                ...
                <div class="d-flex justify-content-evenly col-12">
                    ...
                    <a href="/account/profile-account" id="icon-hover"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
