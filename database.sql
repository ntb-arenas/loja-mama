...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 07, 2022 at 10:15 PM
...
INSERT INTO `invoice_products` (`PRODUCT_ID`, `CODE`, `TYPE`, `NAME`, `QUANTITY`, `PRICE`) VALUES
...
('INV_6598', 'AC1', 'Almofadas Anti-cólicas', 'PINTINHAS', 1, 9),
('INV_6598', 'C1', 'Cunhas', 'AZUL', 1, 45),
('INV_6598', 'KM1', 'Kit Maternidade', 'AZUL CLARO', 1, 18),
...
('INV_3304', 105, 'carolina@gmail.com', '213456789', '945623548', 1, 72, '14:32:52', '2022-07-07'),
('INV_5630', 105, 'carolina@gmail.com', '245123456', '978645123', 3, 277, '14:33:36', '2022-07-07'),
('INV_6598', 111, 'sandrag@gmail.com', '', '456231675', 3, 72, '22:08:02', '2022-07-07'),
...
INSERT INTO `products` (`PACK`, `CODE`, `NAME`, `DESCRIPTION`, `PRICE`, `IMAGE_URL`) VALUES
...
(105, 'carolinap', 'carolina@gmail.com', '$2y$10$No5b.JlzYh6R3X.5ncdI.u2A82RQNlcAkWR/4dxxHeBF.iNB0joQC', 'Carolina', 'Patrocínio', 'Praça José Fontana Nº1, 1RP - Cv/Dta', '1653-589', 'Lisboa', 'Portugal', '965823456', 1, 1, NULL, '', 1, NULL, '2022-05-29 15:34:15'),
...
(110, 'mafaldat', 'mafaldat@gmail.com', '$2y$10$1yntICJ6ObsnWISzKPrk8uX0QsZuFpWnNzPHHYyLWurL/28veAaS2', 'Mafalda', 'Teixeira', 'R. Cova do Grão 340A, São Domingos de Rana', '2785-216', 'Lisboa', 'Portugal', '456231675', 1, 2, NULL, '', 1, '110-review', '2022-06-03 17:00:19'),
(111, 'sandrag', 'sandrag@gmail.com', '$2y$10$uAUNyVPt6Gs5R9ERtGRLE.xRr2y31LrbnH78wslOu1LerQ7weAwfy', 'Sandra', 'Gabriel', 'Praça José Fontana Nº1, 1RP - Cv/Dta', '1070-273', 'Lisboa', 'Portugal', '456231675', 1, 1, NULL, '', 1, '111-review', '2022-06-03 20:18:36'),
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`INVOICE_ID`) REFERENCES `invoice_products` (`PRODUCT_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
