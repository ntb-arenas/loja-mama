        ...
        <table class="table rounded-5" style="background-color: #262626; border-color: gray;">
          <thead>
            <tr>
              ...
              <th class="text-white text-center" scope="col">NEWSLETTERS</th>
              <th class="text-white text-center" scope="col">ACTIONS</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td class="text-white text-center"><?php echo $ID; ?></th>
              <td class="text-white text-center"><?php echo $username; ?></td>
              <td class="text-white text-center"><?php echo $fName . ' ' . $lName; ?></td>
              <td class="text-white text-center"><?php echo $email; ?></td>
              <td class="text-white text-center">
                <form action="#" method="POST">
                  <select name="userStatusOptions" id="userStatusOptions">
                    <option value='
                  <?php
                  if ($userLevel == 1) {
                    if ($userStatus == 2) {
